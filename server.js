...
console.log('✅ SERVIDOR INICIANDO - MODO ACCESO DIRECTO');

// ==================== MIDDLEWARES ====================
app.use(express.json());
app.use(express.static(__dirname, { maxAge: '2h', etag: true }));

// RUTAS HTML - TODAS PÚBLICAS POR AHORA
app.get('/', (req, res) => {
...
// ==================== LOGIN SIMPLE - ACCESO DIRECTO ====================
app.post('/api/login', (req, res) => {
    // ACEPTA CUALQUIER CONTRASEÑA POR AHORA
    const token = `session_${Date.now()}_simple_token`;
    console.log('✅ Login aceptado - acceso directo');
...
async function startServer() {
    ...
    app.listen(PORT, '0.0.0.0', () => {
        ...
        console.log('  🌿 SERENITY SPA - ACCESO DIRECTO');
        console.log('='.repeat(50));
        console.log(`  📍 Puerto: ${PORT}`);
        console.log(`  🔐 CUALQUIER CONTRASEÑA FUNCIONA`);
