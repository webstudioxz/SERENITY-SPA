...
// ✅ CORREGIDO - Página principal ahora sirve I-2.html
app.get('/', (req, res) => res.sendFile(path.join(__dirname, 'I-2.html')));
...
const server = app.listen(PORT, '0.0.0.0', async () => {
    ...
    console.log(`📄 Página principal: I-2.html`);
});
