...
app.post('/api/login', (req, res) => {
    ...
    // Si no hay contraseña configurada en entorno, usar valor por defecto
    // pero mostrar advertencia
    if (!ADMIN_PASSWORD) {
        console.error('⚠️ ADVERTENCIA: ADMIN_PASSWORD no está configurada en variables de entorno');
        console.error('🔐 Usando contraseña por defecto. CAMBIA ESTO EN PRODUCCIÓN');
    }
