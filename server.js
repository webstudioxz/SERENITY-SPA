...
const SESSION_SECRET = process.env.SESSION_SECRET || '7f3a8e2b9c1d4f6a8e2b9c1d4f6a8e2b';

console.log('✅ Servidor iniciando en modo accesible');
...
// VERSIÓN SIMPLIFICADA - ACEPTA CONTRASEÑAS COMUNES PARA PRUEBAS
app.post('/api/login', (req, res) => {
    ...
    // LISTA DE CONTRASEÑAS VÁLIDAS PARA PRUEBAS
    const validPasswords = ['123456', 'admin', 'admin123', 'Serenity2024', 'serenity', 'test'];
    ...
    if (validPasswords.includes(password)) {
        ...
        console.log(`✅ Login exitoso: ${clientIp}`);
        res.json({ success: true, token, expiresIn: 8 * 60 * 60 });
    } else {
        recordFailedAttempt(clientIp);
        console.log(`❌ Login fallido: ${clientIp} - contraseña: ${password}`);
...
async function startServer() {
    ...
    app.listen(PORT, '0.0.0.0', () => {
        ...
        console.log('  🌿 SERENITY SPA - MODO ACCESIBLE');
        console.log('='.repeat(50));
        console.log(`  📍 Puerto: ${PORT}`);
        console.log(`  🔐 Contraseñas válidas: 123456, admin, admin123, Serenity2024, serenity, test`);
