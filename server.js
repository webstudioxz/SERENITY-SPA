...
// Verificar palabras prohibidas y bloquear
...
// ==================== MIDDLEWARE DE BLOQUEO (CON EXCEPCIÓN PARA ADMIN) ====================
...
// RUTA DE EMERGENCIA PARA DESBLOQUEAR (ELIMINAR DESPUÉS DE USAR)
...
app.use((req, res, next) => {
    ...
    // Rutas que NO se bloquean (siempre accesibles)
    const rutasPermitidas = ['/admin', '/admin.html', '/login', '/login.html', '/api/login', '/api/verify', '/admin-emergencia'];
